...
public class UserController implements Serializable{
	...
	private Boolean vuemoduleELAS = true;
	private Boolean vuemoduleDISP = false;
	...
	public void traceSysJournal(String traitement) {
		...
		sj.setSyjFonCod(getSlctd().getTFonction().getFonCod());
	...
	public void switchMenu(String key) throws IOException{
		switch(key){
		case "1": //menu Elaboration
			vuemoduleELAS=true;
			vuemoduleDISP=false;
			renderPage(GRFProperties.HOME);
			break;
		case "2":  //menu parametre system
			vuemoduleELAS=false;
			vuemoduleDISP=true;
			renderPage(GRFProperties.HOME);
			break;
	...
	public String getEmailEmploye(String foncCode){
		try {
			...
			return e.getOpeMail()== null ? "herve.bah@sndi.ci": e.getOpeMail();
		} catch (java.lang.IndexOutOfBoundsException e) {
			_logger.info(" pas d'email d'employé trouvé :");
			return "herve.bah@sndi.ci";
		}
	}	
...
public void afficherMenuAdmin() {
	...
	public Boolean getVuemoduleELAS() {
		return vuemoduleELAS;
	}

	public void setVuemoduleELAS(Boolean vuemoduleELAS) {
		this.vuemoduleELAS = vuemoduleELAS;
	}

	public Boolean getVuemoduleDISP() {
		return vuemoduleDISP;
	}

	public void setVuemoduleDISP(Boolean vuemoduleDISP) {
		this.vuemoduleDISP = vuemoduleDISP;
	}
