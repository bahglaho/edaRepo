...
public class StatutClasse {
	...
	static public String  returnStatutEtapePreparation(String action, String foncCode){
		...
		case "DF":
			//Action = 'DF': Ecran de Validation. Statut  Différe Filtre
			if(!foncCode.equalsIgnoreCase("SLD")){ val = "P1D";}
			
			break;	
			
		case "VD":
			//Action = 'VD': Ecran de Validation. Statut de Traitement Différe
			if(foncCode.equalsIgnoreCase("SLD")){ val = "P1D";}
	...
	static public String  returnLibelleEtapePreparation(String action, String foncCode){
		...
		case "CV":
			//Action = 'DF': Ecran de Validation. Statut  Différe Filtre
			val = "Ecran des calendriers validés";
			
			break;	
		case "DF":
			//Action = 'DF': Ecran de Validation. Statut  Différe Filtre
			if(!foncCode.equalsIgnoreCase("SLD")){ val = "Ecran de taitement du differé";}
