...
public class GRFProperties {
	...
	private static final String PROPERTIES_RESOURCE = "eda".intern();
	...
	//Properties Fonction
	public static final String FON_COD_SIZE_PSEUDO = getProperty("FON_COD_SIZE_PSEUDO", "7"); 
	...
	public static final String PARAM_UPLOAD_DESTINATION_LINUX = getProperty("destinationLinux", "opt/wildfly/standalone/Dossiers/");
	public static final String PARAM_UPLOAD_DESTINATION_TRUE_DOC_LINUX = getProperty("destinationTrueLinux", "opt/wildfly/standalone/Dossiers/trueDoc/");
	public static final String PARAM_SOURCE_LOG = getProperty("sourcelog", "\\standalone\\log\\");
	public static final String PARAM_SOURCE_LOG_LINUX = getProperty("sourceloglinux", "opt/wildfly/standalone/log/");
