...
public class AssignationController {
	...
	@Transactional
	public void updateAssignation() throws IOException {
		//recup de l'operateur et de la fonction
		TOperateur op = new TOperateur(operateur);
		for(TOperateur o: operateurListe) {
			if(o.getOpeMatricule().equalsIgnoreCase(operateur)){
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO," Modification effectué avec succés! ", ""));
		userController.renderPage("ass1");
	}
	...
	public void delete(){
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN," Impossible de supprimer l' Assignation ! ", ""));
		}  
	}
