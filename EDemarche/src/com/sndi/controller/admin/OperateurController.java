...
//TODO
		try {
			if(checkNewOpeStepI()){
			    ...
			    newOpe.setOpeMatricule(keyGen.getOperateurCode());
			  //  newOpe.settTypeOperateur(new TTypeOperateur(structureid));
				...
				FacesContext.getCurrentInstance().addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_INFO, "Opérateur créé avec succès ! ", ""));
	...
	public String update() throws IOException{
		...
		try {
			...
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_INFO, "Modification éffectuée avec succès ! ", ""));
			return renderPage("ope1");
			}
		}catch (Exception e) {
			// TODO Auto-generated catch block
