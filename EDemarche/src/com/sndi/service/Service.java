...
public class Service implements Iservice {
	...
	// DAO is injected...
		...
		public int getSeqNextVal(String seqName) {
			// TODO Auto-generated method stub
			return getDao().getSeqNextVal(seqName);
		}
		public void getSeqIncrement(String seqName, int increment) {
			// TODO Auto-generated method stub
						getDao().getSeqIncrement(seqName, increment);
		}
		...
		@Override
		public int countTableByColumnIn(String tableName,String conditionColumn, String inCondition,  List<String> inList, WhereClause ... conditions) {
			// TODO Auto-generated method stub
			return getDao().countTableByColumnIn(tableName, conditionColumn, Arrays.asList(conditions), inCondition, inList);
		}
		
		@Override
		public int countTableByColumnNotIn(String tableName,String conditionColumn, String notCondition,  List<String> notList, WhereClause ... conditions) {
			// TODO Auto-generated method stub
			return getDao().countTableByColumnNotIn(tableName, conditionColumn, Arrays.asList(conditions), notCondition, notList);
		}
		@Override
		public int countDossierRegisseurCent() {
			return getDao().countDossierRegisseurCent();
		}
