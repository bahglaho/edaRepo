                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center footer">
                        <ul class="list-unstyled list-inline">
                            <li>
                                <a href="#">
                                    <br> <i class="fa fa-angle-right"></i> ALLER SUR LE TABLEAU DE BORD</a>
                            </li>
                            <li>
                                <a href="https://cloe.premierministre.ci/">
                                    <br> <i class="fa fa-angle-right"></i> ALLER SUR LE PORTAIL DE CLOE DECISIONNEL </a>
                            </li>
                            <li>
                                <a href="/cloe-collecte/assistance.jsf">
                                    <br> <i class="fa fa-angle-right"></i> ASSISTANCE & AIDE </a>
                            </li>
            ...
            <section class="col-md-4 content-right">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 logo">
                        <!-- <img src="resources/portail/img/logo.png" class="img-responsive center-block" alt="Amoiries Ci" style=""> -->  
                    </div>
                    <br/><br/><br/><br/><br/><br/><br/>
                    <div class="col-md-12 col-sm-12 col-xs-12 form-entete text-center">
                        <h1> BIENVENUE SUR LE PORTAIL DE CHARGEMENT DES DONNEES DE CLOE COLLECTE </h1>
                    </div>
